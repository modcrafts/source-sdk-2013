...
#if !defined( BSP_USE_LESS_MEMORY ) && !defined( BSP_INCREASE_LIMITS )
// Common limits
...
#define MAX_MAP_DETAILPROPS				65535
...
#elif defined( BSP_INCREASE_LIMITS )
...
#define MAX_MAP_DETAILPROPS				131071
